...
function responderHabilidadeLocal(pergunta = '') {
  ...
  const habilidades = [
    { tipo: TIPOS_PUBLICOS.duvida_digital, origem: 'habilidade_local', termos: ['preciso de ajuda com meu celular'], resposta: { respostaSimples: 'Claro! Posso ajudar com o celular. Escolha uma opção específica, como volume, Wi-Fi, print ou som.', passoAPasso: ['Você pode perguntar: Como aumentar o volume?', 'Você pode perguntar: Como conectar no Wi-Fi?', 'Você pode perguntar: Como tirar print?', 'Se preferir, escreva sua dúvida com suas palavras.'], atencao: '', quandoPedirAjuda: '' } },
    { tipo: TIPOS_PUBLICOS.duvida_digital, origem: 'habilidade_local', termos: ['estou com duvida no whatsapp'], resposta: { respostaSimples: 'Posso ajudar com o WhatsApp. Escolha uma dúvida específica para eu explicar melhor.', passoAPasso: ['Você pode perguntar: Como mandar mensagem no WhatsApp?', 'Você pode perguntar: Como colocar foto no WhatsApp?', 'Você pode perguntar: Recebi um link estranho no WhatsApp.', 'Se quiser, escreva sua dúvida.'], atencao: '', quandoPedirAjuda: '' } },
    { tipo: TIPOS_PUBLICOS.seguranca, origem: 'seguranca_local', termos: ['tenho uma duvida sobre pix ou banco e quero fazer com seguranca'], resposta: { respostaSimples: 'Vamos falar de banco e Pix com cuidado. Antes de pagar, confirme tudo com calma.', passoAPasso: ['Use apenas o aplicativo oficial do banco.', 'Confira o nome de quem vai receber o Pix.', 'Desconfie de urgência e pressão para pagar.', 'Se quiser, pergunte: Como fazer Pix?'], atencao: 'Nunca compartilhe senha, código ou token.', quandoPedirAjuda: 'Peça ajuda antes de confirmar um pagamento.' } },
